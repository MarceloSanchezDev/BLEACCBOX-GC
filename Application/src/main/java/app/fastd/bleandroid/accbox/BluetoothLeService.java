...
/*
    ...
    public boolean connect(final String address) {
        Log.d(TAG, "connect() llamado con address = " + address);
        ...
        // parameter to false.
        Log.d(TAG, "connect() llamado con address = " + address);
        mBluetoothGatt = device.connectGatt(this, false, mGattCallback); //Todo: MY_DEBUG: set autoConnect to true for final solution -> just for manual testing false is used
        Log.d(TAG, "Trying to create a new connection.");
        Log.d(TAG, "connectGatt ejecutado");
...
*/
    ...
    public boolean connect(final String address) {
        ...
        if (mConnectionState == STATE_CONNECTING) {
            Log.d(TAG, "Ya se está intentando conectar");
            return false;
        }
        ...
        if (mConnectionState == STATE_CONNECTED &&
                ...
                mBluetoothGatt != null) {
            Log.d(TAG, "Ya está conectado a este dispositivo");
            return true;
        }
        ...
        try {
            ...
            Log.w(TAG, "Dirección Bluetooth inválida: " + address, e);
            return false;
        }
        ...
        if (mBluetoothGatt != null) {
            Log.d(TAG, "Cerrando conexión GATT previa antes de crear una nueva");
            mBluetoothGatt.close();
            mBluetoothGatt = null;
        }

        Log.d(TAG, "Creando nueva conexión GATT directa");
...
// aver si se puede quitar hasta el final FastD
    ...
    public void readCustomCharacteristic() {
        ...
        //BluetoothGattCharacteristic mReadCharacteristic = mCustomService.getCharacteristic(UUID.fromString("00002a04-0000-1000-8000-00805f9b34fb"));
        //BluetoothGattCharacteristic mReadCharacteristic = mCustomService.getCharacteristic(UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb"));
        //???BluetoothGattCharacteristic mReadCharacteristic = mCustomService.getCharacteristic(UUID.fromString("00002a23-0000-1000-8000-00805f9b34fb"));
    ...
    public void writeCustomCharacteristic(int value) {
        ...
        //get the read characteristic from the service
        //BluetoothGattCharacteristic mWriteCharacteristic = mCustomService.getCharacteristic(UUID.fromString("00002a02-0000-1000-8000-00805f9b34fb"));
